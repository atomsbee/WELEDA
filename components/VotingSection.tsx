      ...
      <div id="influencer-grid">
        ...
        {/* <div className="w-section pb-0">
          <div className="w-container text-center">
            <p className="w-eyebrow">COMMUNITY VOTE</p>
            <h2 className="w-h2">
              Stimm für deinen{' '}
              <span className="w-gradient-text">Favouriten.</span>
            </h2>
          </div>
        </div> */}
        ...
        <div
          className="sticky top-[60px] md:top-[72px] z-30 border-b mt-8"
          style={{
        ...
        >
          <div className="w-container px-4 sm:px-6 py-2">
        ...
        <div className="w-container px-4 pt-10 pb-20">
          <div ref={gridRef} />
          ...
          {influencers.length === 0 ? (
            ...
            <div className="space-y-16 md:space-y-20">
              {groupedByCategory.map((group, groupIndex) => {
                ...
                return (
                  <div key={group.key} id={`category-${group.key}`}>
